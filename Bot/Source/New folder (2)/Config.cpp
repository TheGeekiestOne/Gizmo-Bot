...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "bwapi-data/AI/RedRum-0_1.json";
    }

	namespace IO
	{
		std::string ErrorLogFilename		= "RedRum_ErrorLog.txt";
    ...
    namespace BotInfo
    {
        std::string BotName                 = "RedRum";
        std::string Authors                 = "Ayran Olckers AKA The Geekiest One";
    ...
    namespace BWAPIOptions
    {
        ...
        bool EnableCompleteMapInformation   = true;
    }
